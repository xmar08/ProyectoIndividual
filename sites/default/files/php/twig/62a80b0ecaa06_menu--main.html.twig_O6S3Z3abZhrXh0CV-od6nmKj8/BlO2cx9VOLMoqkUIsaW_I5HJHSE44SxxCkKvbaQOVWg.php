...
/* themes/contrib/elements_theme/templates/navigation/menu--main.html.twig */
class __TwigTemplate_1917382cba1793160670e863d54314764aaf8afcd718029933f44918641e2ea0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) ? ("menu-item--active-trail") : (""))];
        ...
        ";
                    // line 48
                    if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "original_link", [], "any", false, false, true, 48), "pluginDefinition", [], "any", false, false, true, 48), "description", [], "any", false, false, true, 48)) {
                        // line 49
                        echo "          ";
                        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "original_link", [], "any", false, false, true, 49), "pluginDefinition", [], "any", false, false, true, 49), "description", [], "any", false, false, true, 49), 49, $this->source), "html", null, true);
                        echo "
        ";
                    }
                    // line 51
  ...
  ";
    ...
    {
        return "themes/contrib/elements_theme/templates/navigation/menu--main.html.twig";
    }
    ...
    {
        return array (  134 => 57,  127 => 55,  121 => 53,  119 => 52,  116 => 51,  110 => 49,  108 => 48,  102 => 47,  97 => 46,  95 => 43,  94 => 42,  93 => 41,  92 => 39,  90 => 38,  85 => 37,  81 => 35,  75 => 33,  72 => 32,  69 => 31,  66 => 30,  51 => 29,  44 => 27,  41 => 22,  39 => 21,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/contrib/elements_theme/templates/navigation/menu--main.html.twig", "/app/themes/contrib/elements_theme/templates/navigation/menu--main.html.twig");
    }
